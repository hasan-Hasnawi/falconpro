...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-falcon-blue via-falcon-blueDark to-falcon-blue">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Falcon
              <span className="text-falcon-gold">Pro</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl lg:text-2xl text-white/80 font-light mb-4 sm:mb-6"
            >
              {t('subtitle')}
            </motion.p>
